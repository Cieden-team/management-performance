        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-[#000319] rounded-xl border border-[#e9e9e9] dark:border-[#373737] p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-[#646464] dark:text-[#909090]">Active Goals</p>
                <p className="text-2xl font-bold text-[#212121] dark:text-white">
                  {goals.filter(g => g.status === "active").length}
                </p>
              </div>
              <div className="p-3 bg-[#f0e9ff] dark:bg-[#651FFF] rounded-lg">
                <svg className="h-6 w-6 text-[#651FFF] dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white dark:bg-[#000319] rounded-xl border border-[#e9e9e9] dark:border-[#373737] p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-[#646464] dark:text-[#909090]">Feedback Received</p>
                <p className="text-2xl font-bold text-[#212121] dark:text-white">
                  {feedbacks.length}
                </p>
              </div>
